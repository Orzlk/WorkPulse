...
const EXPORT_COLUMNS: Record<ExportTable, readonly string[]> = {
  ...
  work_logs: ['id', 'public_id', 'project_id', 'task_id', 'content', 'category', 'created_at', 'updated_at', 'deleted_at'],
...
const FOREIGN_KEYS: Partial<Record<ExportTable, Record<string, ExportTable>>> = {
  ...
  work_logs: { task_id: 'tasks', project_id: 'projects' },
  inbox_items: { project_id: 'projects' },
  tags: { parent_id: 'tags' },
